        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-3">
              <div className="bg-gradient-to-br from-cyan-400 via-blue-500 to-purple-600 p-2 rounded-lg shadow-lg">
                <Calculator className="h-6 w-6" />
              </div>
              <h3 className="text-2xl font-bold bg-gradient-to-r from-cyan-300 to-purple-300 bg-clip-text text-transparent">Solvix</h3>
            </div>
            <p className="text-blue-200 text-sm leading-relaxed">
              Advanced engineering solutions platform with professional formulas, 
